...
import { displayQty, displayUnit } from '../../utils/unitStandardizer';
    ...
    <div className="demand-card">
      ...
      <div className="demand-card-body">
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.4rem', marginBottom: '1rem' }}>
          {(item.machine || 'Stock / General Care').split(',').map(m => m.trim()).filter(Boolean).map((mac, idx) => (
        ...
        <div className="specs-list">
          ...
          <div className="spec-item">
            ...
            <span className="spec-val">{displayQty(item.qty, item.unit) || '—'}</span>
          </div>
          <div className="spec-item">
            <span className="spec-label">Unit</span>
            <span className="spec-val">{displayUnit(item.qty, item.unit) || '—'}</span>
          </div>
          <div className="spec-item">
